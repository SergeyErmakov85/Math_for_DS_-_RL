...
ВНИМАНИЕ: скрипт РАЗОВЫЙ — им создан каркас пособия, дальше главы писались
руками. Запускать его повторно нельзя: он перезапишет написанное. Его ROOT
(каталог math-textbook внутри репозитория сред) уже не существует — пособие
переехало сюда.

Словарь REPO ниже сохранён как есть, в состоянии на момент генерации каркаса.
Он УСТАРЕЛ: лаборатория сред переехала на раскладку unity/MLAgentsLab/
с двенадцатью средами E00-E11. Живой реестр путей — _meta/unity-bridge.md,
и он единственный: сайт разбирает именно его, чтобы второй, расходящейся
копии этих путей не появилось.
"""
